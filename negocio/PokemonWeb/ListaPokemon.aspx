<%@ Page Title="Lista pokemon | Pokemon App" Language="C#" MasterPageFile="~/PokeMaster.Master" AutoEventWireup="true" CodeBehind="ListaPokemon.aspx.cs" Inherits="PokemonWeb.ListaPokemon" %>
   ...
   <asp:ScriptManager runat="server" ID="scrManagerGrid"></asp:ScriptManager>
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <div class="table-responsive mb-3" style=" overflow-x: auto; -webkit-overflow-scrolling: touch;">
