...
namespace negocio
{
    public class PokemonNegocio
    {
        public List<Pokemon> listarConSP()
        {
            ...
            try
            {
                datos.setearSP("listarProcedure");
        ...
        public List<Pokemon> listar(string id = "")
        {
            ...
            try
            {
                //"server=.\\SQLEXPRESS; database=POKEDEX_DB; integrated security=true";
		...
		public void agregarConSp(Pokemon nuevo)
        {
            ...
            try
            {
                datos.setearSP("storedAddPokemon");                
        ...
        public void modificarConSp(Pokemon poke)
        {
            ...
            try
            {
                datos.setearSP("storedModifPokemon");
